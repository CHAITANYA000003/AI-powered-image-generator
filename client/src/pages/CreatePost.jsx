...
const CreatePost = () => {
  ...
  // while waiting for the image to come from the API
  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        // change the image type later when you add actual api call in dalleRoutes
      } catch (error) {
        alert(error);
      } finally {
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-5">
          ...
          <div className="relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center">
            ...
            {generatingImg && (
              <div className="absolute inset-0 z-0 flex justify-center items-center bg-[rgba(0,0,0,0.5)] roundend-lg">
                <Loader />
              </div>
            )}
          </div>
